...
from lib.benchmark_utils import to_o3d_pcd, get_correspondences
...
class KITTIDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return src_pcd_input, tgt_pcd_input, src_feats, tgt_feats, rot, trans, matching_inds, src_pcd, tgt_pcd, torch.ones(
            1)
